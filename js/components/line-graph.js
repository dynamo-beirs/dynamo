                ...
                interactionSVG += `
                    <g class="interaction-group interaction-group-${key}">
                        ...
                        <g class="box box-${key}">
                            ...
                            <foreignObject class="custom-tooltip-fo" x="0" y="0" width="120" height="160" 
    style="display: none; overflow: visible; opacity: 0; pointer-events: none;">
    <div xmlns="http://www.w3.org/1999/xhtml" class="box-html-content" 
        style="overflow: visible; position: relative;"></div>
</foreignObject>
